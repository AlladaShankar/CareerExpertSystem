% Define subjects and their corresponding careers
subject('Maths').
subject('Physics').
subject('Chemistry').
subject('Biology').
...
% Predicate to collect user input about their interests
input :-
    dynamic(student/2),
    repeat,
    subject(X),
...
% Define subject combinations the student can choose
...
% Output possible subject combinations and career advice based on user's input
output :-
    nl,
    possible_choices,
    nl,
